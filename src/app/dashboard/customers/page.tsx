...
import { CustomersFilters } from '@/components/dashboard/User/user-filters';
import { CustomersTable } from '@/components/dashboard/User/user-table';
import type { Customer } from '@/components/dashboard/User/user-table';
